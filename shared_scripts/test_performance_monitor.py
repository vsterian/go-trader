...
class TestRecordTrade:
    def test_record_profitable(self, tmp_model_dir):
        pm = PerformanceMonitor('test-strat', 'BTC/USDT', model_dir=tmp_model_dir)
...
class TestPersistence:
    def test_roundtrip(self, tmp_model_dir):
        pm1 = PerformanceMonitor('test-strat', 'BTC/USDT', model_dir=tmp_model_dir)
        pm1.record_trade({'pnl': 5.0})
        pm1.record_trade({'pnl': -2.0})

        pm2 = PerformanceMonitor('test-strat', 'BTC/USDT', model_dir=tmp_model_dir)
